// The ids live in `./storeIds` (a module with no imports) and are re-exported
// here so existing importers keep working. Keep that import first: this module
// is part of an import cycle through the boot payload and the platform
// registry, and the ids must be initialised before anything in that cycle runs.
import {
