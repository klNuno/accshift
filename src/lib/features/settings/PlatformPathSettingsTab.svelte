<script lang="ts">
  ...
  let {
    ...
    platformId,
    cardTitleKey,
    showLastLoginLabelKey,
    showLastLoginDefault = false,
    pathLabelKey,
    pathPlaceholder,
  }: {
    ...
    showLastLoginLabelKey: MessageKey;
    showLastLoginDefault?: boolean;
    pathLabelKey: string;
...
<SettingsCard title={t("settings.accountDisplay")} {accent}>
  <ToggleSetting
    label={t(showLastLoginLabelKey)}
    enabled={settings.accountDisplay.showLastLoginPerPlatform[platformId] ?? showLastLoginDefault}
    accent={accent}
    onLabel={t("common.on")}
    offLabel={t("common.off")}
    onToggle={() => settings.accountDisplay.showLastLoginPerPlatform[platformId] = !settings.accountDisplay.showLastLoginPerPlatform[platformId]}
  />
</SettingsCard>

<SettingsCard title={t(cardTitleKey)} {accent}>
  <div class="field">
