...
<SettingsCard title={t("settings.accountDisplay")} {accent}>
  <ToggleSetting
    label={t("settings.showEpicLastLogin")}
    enabled={settings.accountDisplay.showLastLoginPerPlatform["epic"] ?? true}
    accent={accent}
    onLabel={t("common.on")}
    offLabel={t("common.off")}
    onToggle={() => settings.accountDisplay.showLastLoginPerPlatform["epic"] = !settings.accountDisplay.showLastLoginPerPlatform["epic"]}
  />
</SettingsCard>

<SettingsCard title={t("settings.epic")} {accent}>
  <div class="field">
