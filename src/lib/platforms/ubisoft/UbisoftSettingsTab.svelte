...
<SettingsCard title={t("settings.accountDisplay")} {accent}>
  <ToggleSetting
    label={t("settings.showUbisoftLastLogin")}
    enabled={settings.accountDisplay.showLastLoginPerPlatform["ubisoft"] ?? true}
    accent={accent}
    onLabel={t("common.on")}
    offLabel={t("common.off")}
    onToggle={() => settings.accountDisplay.showLastLoginPerPlatform["ubisoft"] = !settings.accountDisplay.showLastLoginPerPlatform["ubisoft"]}
  />
</SettingsCard>

<SettingsCard title={t("settings.ubisoft")} {accent}>
  <div class="field">
