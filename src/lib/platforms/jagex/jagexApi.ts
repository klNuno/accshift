...
import type { JagexAccount, JagexStartupSnapshot } from "./types";

const api = createPlatformApi("jagex");

export const getAccounts = api.getAccounts<JagexAccount>;
export const getCurrentAccount = api.getCurrentAccount;
export const getStartupSnapshot = api.getStartupSnapshot<JagexStartupSnapshot>;
